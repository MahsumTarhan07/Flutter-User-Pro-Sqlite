...
class KisilerDaoRepositor {
  Future<void> KisilerKayit(String kisi_ad, String kisi_tel) async {
  ...
  Future<void> KisiGuncele(int kisi_id, String kisi_ad, String kisi_tel) async {
    var db = await VeritabaniYardimcisi.veritabaniErisim();
    var bilgiler  = Map<String, dynamic>();
  ...
  Future<List<Kisiler>> tumKisilerAl() async {
    var db = await VeritabaniYardimcisi.veritabaniErisim();
